...
# SQL Editor
createDBText = 'Create database testdb;'
...
create index  stock_idx1 on stock(s_w_id,s_i_id,s_quantity);

drop index stock_idx1 on stock;

alter table stock add column (s_deleted_at datetime);

select * from stock;

insert into stock values (100, 101, 1000, 'AA','BB','CC','DD','EE','FF','GG','HH','II','JJ',100,1000,1000,'something',now());
insert into stock values (101, 102, 1000, 'AA','BB','CC','DD','EE','FF','GG','HH','II','JJ',100,1000,1000,'something',now());
insert into stock values (102, 103, 1000, 'AA','BB','CC','DD','EE','FF','GG','HH','II','JJ',100,1000,1000,'something',now());

update stock set  s_data='something new' where s_i_id = 100;

delete from stock where s_i_id=102;
